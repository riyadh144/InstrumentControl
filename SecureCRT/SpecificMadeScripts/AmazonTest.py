...
C:\Users\ralalami\OneDrive - Xirgo Technologies, LLC\XirgoTech\Customer Samples\CTS\02252019
update_file = 'C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\02252019\\AAb6-1133HA1-e2.bin'
#update_file='NULL'
#boot_file ='C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\Navistar\\03152019\\AAzB-1133BD1.bin'
boot_file='NULL'
Script_File = "C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\02252019\AWS_script_v3.bin"
#Script_File="NULL"
Parameters_File="C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\02252019\AWS_params_v4.txt"
...
TPS_FILE="NULL"
CSV_FILE="C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\02252019\03182019Amazon.txt"
Cert_File="C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\02252019\\"
#Cert_File="NULL"
import AES
import time
import os
    ...
    if(stop):
		...
		if(stop):
			...
			if(Cert_File!="NULL"):
				...
				subprocess.Popen([r'wsl.exe'])
				time.sleep(15)
				cmd(scr, 0.5, ':qti', 0.0)
				cmd(scr, 0.5, ':g1trst x 2', 0.0)

				reswait(scr, 'Waiting for Xmodem Start (Ctrl-D twice to cancel)', 15.0)
				Cert_File=Cert_File+(IMEI.replace("\n","").replace("\r","")+"_TRUSTSTORE.bin")
				crt.FileTransfer.SendXmodem(Cert_File)
				reswait(scr, 'Download Successful', 5.0)
				cmd(scr, 0.5, ':etm', 1.0)
				cmd(scr, 0.5, ':wtdm 0x1f', 1.0)
				reswait(scr, 'GsmIdle', 10.0)
				cmd(scr,0.5,':utcmd bypass',10)
				reswait(scr, 'State: UserBypass,', 5.0)
				
				cmd(scr,0.5,':dtm',5)
				cmd(scr,0.5,':wttrst',5)

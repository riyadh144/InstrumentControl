...
def main():
    ...
    cmd(scr, 5,'!csq', 0.1)
    cmd(scr, 0.1,'mV', 0.1)
    cmd(scr,0.1,'+XT:1004,firmware,cpftpuser,cpftppass,10.1.0.4,21,0,3',0.1)
    cmd(scr,0.1,'+XT:1001,22040,10.3.130.5,6,0,90,0',0.1)
    cmd(scr,0.1,'+XT:1002,,,skyblue01.com.attz',0.1)
    cmd(scr,0.1,'+XT:1008,53340003',0.1)
    cmd(scr,0.1,'+XT:3004,0',0.1)
    cmd(scr,0.1,'+XT:3006,0',0.1)
    cmd(scr,0.1,'+XT:3008,10.2',0.1)
    cmd(scr,0.1,'+XT:3010,1500,1',0.1)
    cmd(scr,0.1,'+XT:3012,1',0.1)
    cmd(scr,0.1,'+XT:3029,2',0.1)
    cmd(scr,0.1,'+XT:7008,BHPHS20',0.1)
    cmd(scr,0.1,'+XT:1004?',0.1)
    cmd(scr,0.1,'+XT:1001?',0.1)
    cmd(scr,0.1,'+XT:1002?',0.1)
    cmd(scr,0.1,'+XT:1008?',0.1)
    cmd(scr,0.1,'+XT:3004?',0.1)
    cmd(scr,0.1,'+XT:3006?',0.1)
    cmd(scr,0.1,'+XT:3008?',0.1)
    cmd(scr,0.1,'+XT:3010?',0.1)
    cmd(scr,0.1,'+XT:3012?',0.1)
    cmd(scr,0.1,'+XT:3029?',0.1)
    cmd(scr,0.1,'+XT:7008?',0.1)
    cmd(scr, 0.1,'!csq', 0.1)
    cmd(scr, 0.1,'mV', 0.1)

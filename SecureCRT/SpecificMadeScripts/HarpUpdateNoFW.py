...
update_file = '/home/quanta/OneDrive/XirgoTech/CustomerSamples/GFI/20190813/AAb1-1133GE1.bin'
update_file='NULL'
boot_file ='/home/quanta/OneDrive/XirgoTech/CustomerSamples/GFI/20190813/AAzB-1133BD1.bin'
boot_file='NULL'
Script_File = "/home/quanta/OneDrive/XirgoTech/CustomerSamples/GFI/20190813/GFIsystems_script.bin"
#Script_File="NULL"
Parameters_File="/home/quanta/OneDrive/XirgoTech/CustomerSamples/GFI/20190813/GFI_param_Heavy_duty.txt"
...
TPS_FILE="NULL"
CSV_FILE="/home/quanta/OneDrive/XirgoTech/CustomerSamples/GFI/20190813/GFI20190813.txt"
...
def main():
    ...
    if(Parameters_File!="NULL"):
         ...
         cmd(scr, 10, '',0.0)         
         cmd(scr, 30, '',0.0)         
         cmd(scr, 5, ':wycfg ver[1] "GFI_param_Heavy_duty.txt" 53',0.0)
         cmd(scr, 0.5, ':wycfg ver[0] "GFI_script_tamper_ACK.bin" 41',0.0)
         
         #cmd(scr, 0.5, ':rtval mno 8',0.0)
         time.sleep(60)
         cmd(scr, 20, ':ett',0.0)
         cmd(scr, 4, 'at+CGDCONT=3,"IPV4V6","SO01.VZWSTATIC"',0.0)

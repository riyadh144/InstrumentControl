...
TPS_FILE="NULL"
CSV_FILE="C:\\Users\\ralalami\\OneDrive - Xirgo Technologies, LLC\\XirgoTech\\Customer Samples\\CTS\\05212019\\05222019Amazon.txt"
...
def aes_login(scr):
    ...
    if(login_string=="ERROR"):
        ...
        dec_string=subprocess.call('C:\Users\riyad\OneDrive - Xirgo Technologies, LLC\XirgoTech\aes_Psswd>'+login_list)
    ...
    if(stop):
		...
		if(stop):
			...
			if(Cert_File!="NULL"):
				...
				reswait(scr, 'State: UserBypass,', 15.0)
